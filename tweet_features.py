...
#         user_tweets[name] = []
#
#     user_tweets[name].append(str(worksheet.cell(i,1)))
#
#
# # print user_tweets
#
# pickle.dump(user_tweets, open("user_tweets.p", 'wb'),-1)
#
...
def proportion_using_total_words(user_tweets): #NO STRIP FOR INPUT WORDS
    politic = open("focus past.txt","r").read().split("\r")
    print politic
    user_education = {}
    ...
    smiley_out = open("focus past.csv","w")
...
if __name__ == "__main__":
    ...
    user_merged_tweets = pickle.load(open("user_merged_tweets.p", 'rb'))
    # print user_merged_tweets
